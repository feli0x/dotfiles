...
alias ftn='cat ~/.ftn && sleep 3  && sudo airmon-ng start wlan1 && sudo wifite --clients-only --dict passlist.txt'
alias htp='cat ~/.htp && sleep 3 && sudo airmon-ng start wlan1 && kismet -c wlan1mon'
...
alias ohyeah='sudo aircrack-ng wpa.cap -w passlist.txt'
alias ohfuckyeah='sudo aircrack-ng wpa.cap -w weakpass_2'
